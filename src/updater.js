...
let dlinfo = {}
const spare = ['node_modules','config.json']
...
module.exports = {
    CheckForUpdates: async function () {
        try {
        let UpdateInfo = await GetUpdateInfo('https://api.github.com/repos/winor/rpilc/releases/latest')
